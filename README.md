...
A minimal browser extension (Firefox + Chrome) that adds a button to [Claude.ai](https://claude.ai) for exporting the current conversation to a plain-text `.txt` file.
